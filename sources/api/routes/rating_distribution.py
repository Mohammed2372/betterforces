...
class RatingDistributionController(Controller):
    ...
    async def get_rating_distribution(
        ...
        limit: int = Parameter(default=100, ge=1, le=1000, description="Maximum number of items to return"),
        offset: int = Parameter(default=0, ge=0, description="Number of items to skip"),
        start_date: Optional[datetime] = Parameter(default=None, description="Start date/time (inclusive) - only return problems solved on or after this date. Format: ISO 8601 (e.g., 2024-01-01 or 2024-01-01T12:00:00)"),
        end_date: Optional[datetime] = Parameter(default=None, description="End date/time (inclusive) - only return problems solved on or before this date. Format: ISO 8601 (e.g., 2024-12-31 or 2024-12-31T23:59:59)")
